...
#include "tensorflow/lite/micro/kernels/xtensa/xtensa_strided_slice.h"
...
TfLiteStatus StridedSlice_int16_hifi(TfLiteContext* context, TfLiteNode* node)
{
  ...
  const RuntimeShape unextended_input_shape = tflite::micro::GetTensorShape(input);
  const RuntimeShape unextended_output_shape = tflite::micro::GetTensorShape(output);
  ...
  TF_LITE_ENSURE_EQ(context, xa_nn_strided_slice_int16(output_data, input_data, static_cast<int>(start_0),
                            ...
                            input_shape.Dims(3), input_shape.Dims(4)), 0);
   return kTfLiteOk;                          
}
...
TfLiteStatus StridedSlice_int32_hifi(TfLiteContext* context, TfLiteNode* node) 
{
  ...
  TF_LITE_ENSURE_EQ(context, xa_nn_strided_slice_int32(output_data, input_data, static_cast<int>(start_0),
                            static_cast<int>(stop_0), static_cast<int>(start_1),
                            static_cast<int>(stop_1), static_cast<int>(start_2),
                            static_cast<int>(stop_2), static_cast<int>(start_3),
                            static_cast<int>(stop_3), static_cast<int>(start_4),
...
TfLiteStatus StridedSlice_int8_hifi(TfLiteContext* context, TfLiteNode* node)
{
  ...
  TF_LITE_ENSURE_EQ(context, xa_nn_strided_slice_int8(
