...
TfLiteStatus EvalSubInt16(TfLiteContext* context, TfLiteNode* node) {
  auto* params = reinterpret_cast<TfLiteSubParams*>(node->builtin_data);
...
#if defined(HIFI3) || defined(HIFI4) || defined(HIFI5)  
  return tflite::micro::RegisterOp(SubInit, SubPrepare, EvalSubInt8);
#else
  return tflite::micro::RegisterOp(SubInit, SubPrepare, EvalSubInt8Reference);
#endif  
}

TFLMRegistration Register_SUB_INT16() {
#if defined(HIFI3) || defined(HIFI4) || defined(HIFI5)   
  return tflite::micro::RegisterOp(SubInit, SubPrepare, EvalSubInt16);
#else
...
TFLMRegistration Register_SUB_FLOAT32() {
  ...
  return tflite::micro::RegisterOp(SubInit, SubPrepare, EvalSubFloat32);
#else
  return tflite::micro::RegisterOp(SubInit, SubPrepare, EvalSubInt16Reference);
#endif     
}
